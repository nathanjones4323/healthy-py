...
from db.synchronous import create_raw_tables

# Create a new logger
logger.add("logs/log_{time}.log", rotation="500 MB", compression="zip")

# Ensure raw tables exist with the desired schema before loading data
create_raw_tables()
...
load_apple_health_data(
    apple_health_sleep_df,
    table_name="apple_health_sleep_raw",
)
load_apple_health_data(
    apple_health_activity_df,
